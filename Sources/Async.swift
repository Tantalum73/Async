...
struct Async {
     ...
     */
    static func main(after: Double? = nil, block: dispatch_block_t) -> Async {
     ...
     **What kind of operations should be performed on the main queue?** *Apples documentation says:*
     ...
     - seeAlso: QualityOfService
     */
    static func background(after: Double? = nil, block: dispatch_block_t) -> Async {
     ...
     **What kind of operations should be performed on the main queue?** *Apples documentation says:*
     ...
     - seeAlso: QualityOfService
     */
    static func userInteractive(after: Double? = nil, block: dispatch_block_t) -> Async {
     ...
     **What kind of operations should be performed on the main queue?** *Apples documentation says:*
     ...
     - seeAlso: QualityOfService
     */
    static func userInitiated(after: Double? = nil, block: dispatch_block_t) -> Async {
     ...
     **What kind of operations should be performed on the main queue?** *Apples documentation says:*
     ...
     - seeAlso: QualityOfService
     */
    static func utility(after: Double? = nil, block: dispatch_block_t) -> Async {
    ...
    /**
     ...
     - seeAlso: QualityOfService
     */
    static func defaultPriority(after: Double? = nil, block: dispatch_block_t) -> Async {
    ...
    /**
     ...
     - seeAlso: QualityOfService
     */
    static func async(after after: Double? = nil, QOS: QualityOfService, block: dispatch_block_t) -> Async {
    ...
    func main(after after: Double? = nil, block: dispatch_block_t) -> Async {
        let queue = Async.queueForQualityOfService(.Main)
        
        return chainBlock(after: after, block: block, onQueue: queue)
    }
    
    func background(after after: Double? = nil, block: dispatch_block_t) -> Async {
        let queue = Async.queueForQualityOfService(.Background)
        
        return chainBlock(after: after, block: block, onQueue: queue)
    }
    
    func userInteractive(after after: Double? = nil, block: dispatch_block_t) -> Async {
        let queue = Async.queueForQualityOfService(.UserInteractive)
        
        return chainBlock(after: after, block: block, onQueue: queue)
    }
    
    func userInitiated(after after: Double? = nil, block: dispatch_block_t) -> Async {
        let queue = Async.queueForQualityOfService(.UserInitiated)
        
        return chainBlock(after: after, block: block, onQueue: queue)
    }
    
    func utility(after after: Double? = nil, block: dispatch_block_t) -> Async {
        let queue = Async.queueForQualityOfService(.Utility)
        
        return chainBlock(after: after, block: block, onQueue: queue)
    }
    
    func defaultPriority(after after: Double? = nil, block: dispatch_block_t) -> Async {
        let queue = Async.queueForQualityOfService(.Default)
    ...
    func then(after after: Double? = nil, QOS: QualityOfService, block: dispatch_block_t) -> Async {
        let queue = Async.queueForQualityOfService(QOS)
